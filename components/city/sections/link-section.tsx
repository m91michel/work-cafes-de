...
export async function LinkSection({ className }: LinkSectionProps) {
  ...
  return (
    <section className={cn("max-w-7xl mx-auto px-4 py-12 mb-12", className)}>
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4">
        <div className="flex-1 text-center font-bold">
          <h3>
            <TransHighlight
              i18nKey="all_cities.by_country.title"
              namespace="home"
            />
          </h3>
          <CitySelectorByCountry
            countries={byCountries}
        ...
        <div className="flex-1 text-center font-bold">
          <h3>
            <TransHighlight
              i18nKey="all_cities.by_cafe_count.title"
              namespace="home"
            />
          </h3>
        ...
        <div className="flex-1 text-center font-bold">
          <h3>
            <TransHighlight
              i18nKey="all_cities.by_population.title"
              namespace="home"
            />
          </h3>
